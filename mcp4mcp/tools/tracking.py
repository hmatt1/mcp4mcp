...
async def get_session_analytics(
    ...
    try:
        ...
        for session in recent_sessions:
            ...
            if day_key not in actions_by_day:
                actions_by_day[day_key] = 0
            actions_by_day[day_key] += len(session.actions_taken)
        ...
        return {
            ...
            "analytics": {
                ...
                "unique_tools_worked_on": len(tools_worked_on),
                "tools_list": list(tools_worked_on),
                "actions_by_day": actions_by_day,
                "average_session_time": str(total_time / len(recent_sessions)) if recent_sessions else "0:00:00"
            }
        }
